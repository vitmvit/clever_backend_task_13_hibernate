...
4. Необходимо придумать примеры использования следующих паттернов и реализовать их в коде:
...
- паттерн "Фасад" решает проблему лишних конвертаций на уровне сервиса при взаимодействии с другими
  сервисами;
- паттерн "Наблюдатель" позволяет более гибко генерировать uuid при создании новой сущности;
- паттерн "Стратегия" позволяет выбирать стратегию обновления сущности в зависимости от ситуации.
